...
/** Income represents the reward information of a session. */
...
export const Params = {
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    if (
      object.challengeCidTime !== undefined &&
    ...
    if (
      ...
      message.challengeReplyTime = Duration.fromPartial(
        object.challengeReplyTime,
      );
    }
    if (
      ...
      message.challengeMerkleTime = Duration.fromPartial(
        object.challengeMerkleTime,
      );
    }
    if (
      ...
      message.challengeOriginTime = Duration.fromPartial(
...
export const Payment = {
  ...
  fromJSON(object: any): Payment {
    ...
    if (Array.isArray(object?.contributions))
      obj.contributions = object.contributions.map((e: any) =>
        PaymentContribution.fromJSON(e),
      );
    return obj;
  },
  toJSON(message: Payment): JsonSafe<Payment> {
    ...
    if (message.inputTokens) {
      obj.inputTokens = message.inputTokens.map((e) =>
    ...
    if (message.outputTokens) {
      obj.outputTokens = message.outputTokens.map((e) =>
        (e || Long.UZERO).toString(),
      );
    } else {
      obj.outputTokens = [];
...
export const Income = {
  ...
  toJSON(message: Income): JsonSafe<Income> {
    const obj: any = {};
    if (message.amount) {
