/* eslint-disable */
import { Params, AgentStatus, TokenPrice, agentStatusFromJSON, agentStatusToJSON } from "./agent";
import { Coin } from "../../cosmos/base/v1beta1/coin";
import { RequestLog } from "../../dht/v1/reputation";
...
/**
 * MsgRegisterInferenceAgentResponse defines the Msg/RegisterInferenceAgent
 * response type.
 */
...
/**
 * MsgUpdateInferenceAgentResponse defines the Msg/UpdateInferenceAgent response
 * type.
 */
...
/**
 * MsgRemoveInferenceAgentResponse defines the Msg/RemoveInferenceAgent response
 * type.
 */
...
/**
 * MsgSubmitInferenceRequestResponse defines the Msg/SubmitInferenceRequest
 * response type.
 */
...
/**
 * MsgDeleteExpiredSessionResponse defines the Msg/DeleteExpiredSession response
 * type.
 */
...
export const MsgRemoveInferenceAgent = {
  ...
  encode(message: MsgRemoveInferenceAgent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.account !== "") {
      writer.uint32(10).string(message.account);
    }
    if (message.sender !== "") {
...
export const MsgRemoveInferenceAgentResponse = {
  ...
  encode(_: MsgRemoveInferenceAgentResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
...
export const MsgSubmitInferenceRequest = {
  ...
  encode(message: MsgSubmitInferenceRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
...
export const MsgSubmitInferenceRequestResponse = {
  ...
  encode(message: MsgSubmitInferenceRequestResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): MsgSubmitInferenceRequestResponse {
    ...
    if (isSet(object.requestLog)) obj.requestLog = RequestLog.fromJSON(object.requestLog);
    return obj;
  },
  toJSON(message: MsgSubmitInferenceRequestResponse): JsonSafe<MsgSubmitInferenceRequestResponse> {
    const obj: any = {};
    message.requestLog !== undefined && (obj.requestLog = message.requestLog ? RequestLog.toJSON(message.requestLog) : undefined);
    return obj;
  },
...
export interface Msg {
  ...
  /**
   * RegisterInferenceAgent defines a method to register an inference agent to
   * the chain.
   */
  RegisterInferenceAgent(request: MsgRegisterInferenceAgent): Promise<MsgRegisterInferenceAgentResponse>;
  /**
   * UpdateInferenceAgent defines a method to update an existing inference
   * agent.
   */
  UpdateInferenceAgent(request: MsgUpdateInferenceAgent): Promise<MsgUpdateInferenceAgentResponse>;
  /**
   * RemoveInferenceAgent defines a method to remove an existing inference
   * agent.
   */
