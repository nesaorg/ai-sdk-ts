...
export const ReputationParams = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 36:
          ...
          break;
        case 37:
          message.catchUpPower = reader.uint64() as Long;
          break;
        case 38:
  ...
  fromJSON(object: any): ReputationParams {
    ...
    if (isSet(object.wS)) obj.wS = String(object.wS);
    ...
    if (isSet(object.dr)) obj.dr = String(object.dr);
    if (isSet(object.ap)) obj.ap = String(object.ap);
