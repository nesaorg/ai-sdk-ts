...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break;
        case 8:
          message.minerUnbonding.push(
            UnbondingEntry.decode(reader, reader.uint32()),
          );
          break;
        case 9:
          message.orchestratorUnbonding.push(
            UnbondingEntry.decode(reader, reader.uint32()),
          );
          break;
        case 10:
        ...
        case 11:
          ...
          break;
        case 12:
          message.modelConfigs.push(
            ModelConfig.decode(reader, reader.uint32()),
          );
          break;
        case 13:
          message.reputationParams = ReputationParams.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (Array.isArray(object?.model))
      obj.model = object.model.map((e: any) => Model.fromJSON(e));
    if (Array.isArray(object?.node))
      obj.node = object.node.map((e: any) => Node.fromJSON(e));
    if (Array.isArray(object?.miner))
      obj.miner = object.miner.map((e: any) => Miner.fromJSON(e));
    if (Array.isArray(object?.orchestrator))
      obj.orchestrator = object.orchestrator.map((e: any) =>
        Orchestrator.fromJSON(e),
      );
    if (Array.isArray(object?.orchestratorMiner))
      obj.orchestratorMiner = object.orchestratorMiner.map((e: any) =>
        OrchestratorMiner.fromJSON(e),
      );
    if (Array.isArray(object?.minerUnbonding))
      obj.minerUnbonding = object.minerUnbonding.map((e: any) =>
        UnbondingEntry.fromJSON(e),
      );
    if (Array.isArray(object?.orchestratorUnbonding))
      obj.orchestratorUnbonding = object.orchestratorUnbonding.map((e: any) =>
        UnbondingEntry.fromJSON(e),
      );
    ...
    if (Array.isArray(object?.modelConfigs))
      obj.modelConfigs = object.modelConfigs.map((e: any) =>
        ModelConfig.fromJSON(e),
      );
  ...
  toJSON(message: GenesisState): JsonSafe<GenesisState> {
    ...
    if (message.minerUnbonding) {
      obj.minerUnbonding = message.minerUnbonding.map((e) =>
    ...
    if (message.modelConfigs) {
      obj.modelConfigs = message.modelConfigs.map((e) =>
        e ? ModelConfig.toJSON(e) : undefined,
      );
    } else {
      obj.modelConfigs = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    if (
      object.reputationParams !== undefined &&
      object.reputationParams !== null
    ) {
      message.reputationParams = ReputationParams.fromPartial(
        object.reputationParams,
      );
    }
    return message;
  },
