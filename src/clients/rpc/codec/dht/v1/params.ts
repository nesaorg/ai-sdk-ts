...
export const Params = {
  ...
  encode(
    ...
    if (message.orchestratorMinDeposit !== undefined) {
      Coin.encode(
        message.orchestratorMinDeposit,
        writer.uint32(18).fork(),
      ).ldelim();
    }
    if (message.minerMinDeposit !== undefined) {
      Coin.encode(message.minerMinDeposit, writer.uint32(26).fork()).ldelim();
    }
    if (message.orchestratorUnbondingPeriod !== undefined) {
      Duration.encode(
        message.orchestratorUnbondingPeriod,
        writer.uint32(34).fork(),
      ).ldelim();
    }
    if (message.minerUnbondingPeriod !== undefined) {
      Duration.encode(
        message.minerUnbondingPeriod,
        writer.uint32(42).fork(),
      ).ldelim();
    }
    if (message.labelAdminAccount !== '') {
      writer.uint32(50).string(message.labelAdminAccount);
    }
    if (message.reputationAdminAccount !== '') {
      writer.uint32(58).string(message.reputationAdminAccount);
    }
    ...
    if (message.modelDefaultTokenPrice !== undefined) {
      TokenPrice.encode(
        message.modelDefaultTokenPrice,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.orchestratorUnbondingPeriod = Duration.decode(
            reader,
            reader.uint32(),
          );
          break;
        case 5:
          message.minerUnbondingPeriod = Duration.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 8:
          ...
          break;
        case 9:
          message.modelDefaultTokenPrice = TokenPrice.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromJSON(object: any): Params {
    ...
    if (isSet(object.minerMinDeposit))
      obj.minerMinDeposit = Coin.fromJSON(object.minerMinDeposit);
    if (isSet(object.orchestratorUnbondingPeriod))
      obj.orchestratorUnbondingPeriod = Duration.fromJSON(
        object.orchestratorUnbondingPeriod,
      );
    if (isSet(object.minerUnbondingPeriod))
      obj.minerUnbondingPeriod = Duration.fromJSON(object.minerUnbondingPeriod);
    if (isSet(object.labelAdminAccount))
    ...
    if (isSet(object.modelDefaultTokenPrice))
      obj.modelDefaultTokenPrice = TokenPrice.fromJSON(
        object.modelDefaultTokenPrice,
      );
    return obj;
  },
  toJSON(message: Params): JsonSafe<Params> {
    ...
    message.minerMinDeposit !== undefined &&
      (obj.minerMinDeposit = message.minerMinDeposit
        ? Coin.toJSON(message.minerMinDeposit)
        : undefined);
    ...
    message.minerUnbondingPeriod !== undefined &&
      (obj.minerUnbondingPeriod = message.minerUnbondingPeriod
        ...
        : undefined);
    message.labelAdminAccount !== undefined &&
      (obj.labelAdminAccount = message.labelAdminAccount);
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    if (
      object.orchestratorMinDeposit !== undefined &&
      object.orchestratorMinDeposit !== null
    ) {
      message.orchestratorMinDeposit = Coin.fromPartial(
        object.orchestratorMinDeposit,
      );
    }
    if (
      object.minerMinDeposit !== undefined &&
      object.minerMinDeposit !== null
    ) {
      message.minerMinDeposit = Coin.fromPartial(object.minerMinDeposit);
    }
    if (
      object.orchestratorUnbondingPeriod !== undefined &&
      object.orchestratorUnbondingPeriod !== null
    ) {
      message.orchestratorUnbondingPeriod = Duration.fromPartial(
        object.orchestratorUnbondingPeriod,
      );
    }
    if (
      object.minerUnbondingPeriod !== undefined &&
      object.minerUnbondingPeriod !== null
    ) {
      message.minerUnbondingPeriod = Duration.fromPartial(
        object.minerUnbondingPeriod,
      );
    }
    ...
    if (
      object.modelDefaultTokenPrice !== undefined &&
      object.modelDefaultTokenPrice !== null
    ) {
      message.modelDefaultTokenPrice = TokenPrice.fromPartial(
        object.modelDefaultTokenPrice,
      );
    }
    return message;
