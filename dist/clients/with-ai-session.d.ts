 ...
 */
export declare function withAISession<T extends AISession, R = void>(createSession: () => Promise<T> | T, useSession: (session: T) => Promise<R> | R, options?: WithAISessionOptions): Promise<R>;
//# sourceMappingURL=with-ai-session.d.ts.map