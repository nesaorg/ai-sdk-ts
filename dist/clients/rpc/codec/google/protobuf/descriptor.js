...
export const FileDescriptorSet = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.file))
            obj.file = object.file.map((e) => FileDescriptorProto.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
...
export const FileDescriptorProto = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.messageType))
            obj.messageType = object.messageType.map((e) => DescriptorProto.fromJSON(e));
        if (Array.isArray(object?.enumType))
            obj.enumType = object.enumType.map((e) => EnumDescriptorProto.fromJSON(e));
        if (Array.isArray(object?.service))
            obj.service = object.service.map((e) => ServiceDescriptorProto.fromJSON(e));
        if (Array.isArray(object?.extension))
            obj.extension = object.extension.map((e) => FieldDescriptorProto.fromJSON(e));
...
export const DescriptorProto = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.field))
            obj.field = object.field.map((e) => FieldDescriptorProto.fromJSON(e));
        if (Array.isArray(object?.extension))
            obj.extension = object.extension.map((e) => FieldDescriptorProto.fromJSON(e));
        if (Array.isArray(object?.nestedType))
            obj.nestedType = object.nestedType.map((e) => DescriptorProto.fromJSON(e));
        if (Array.isArray(object?.enumType))
            obj.enumType = object.enumType.map((e) => EnumDescriptorProto.fromJSON(e));
        if (Array.isArray(object?.extensionRange))
            obj.extensionRange = object.extensionRange.map((e) => DescriptorProto_ExtensionRange.fromJSON(e));
        if (Array.isArray(object?.oneofDecl))
            obj.oneofDecl = object.oneofDecl.map((e) => OneofDescriptorProto.fromJSON(e));
        if (isSet(object.options))
            obj.options = MessageOptions.fromJSON(object.options);
        if (Array.isArray(object?.reservedRange))
            obj.reservedRange = object.reservedRange.map((e) => DescriptorProto_ReservedRange.fromJSON(e));
...
export const ExtensionRangeOptions = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.uninterpretedOption))
            obj.uninterpretedOption = object.uninterpretedOption.map((e) => UninterpretedOption.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
...
export const EnumDescriptorProto = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.value))
            obj.value = object.value.map((e) => EnumValueDescriptorProto.fromJSON(e));
        if (isSet(object.options))
            obj.options = EnumOptions.fromJSON(object.options);
        if (Array.isArray(object?.reservedRange))
            obj.reservedRange = object.reservedRange.map((e) => EnumDescriptorProto_EnumReservedRange.fromJSON(e));
        if (Array.isArray(object?.reservedName))
            obj.reservedName = object.reservedName.map((e) => String(e));
        return obj;
    },
...
export const ServiceDescriptorProto = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.method))
            obj.method = object.method.map((e) => MethodDescriptorProto.fromJSON(e));
        if (isSet(object.options))
...
export const UninterpretedOption = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.name))
            obj.name = object.name.map((e) => UninterpretedOption_NamePart.fromJSON(e));
        if (isSet(object.identifierValue))
            obj.identifierValue = String(object.identifierValue);
        if (isSet(object.positiveIntValue))
            obj.positiveIntValue = Long.fromValue(object.positiveIntValue);
        if (isSet(object.negativeIntValue))
            obj.negativeIntValue = Long.fromValue(object.negativeIntValue);
...
export const SourceCodeInfo = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.location))
            obj.location = object.location.map((e) => SourceCodeInfo_Location.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
...
export const GeneratedCodeInfo = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.annotation))
            obj.annotation = object.annotation.map((e) => GeneratedCodeInfo_Annotation.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
...
export const GeneratedCodeInfo_Annotation = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.path))
            obj.path = object.path.map((e) => Number(e));
        if (isSet(object.sourceFile))
            obj.sourceFile = String(object.sourceFile);
        if (isSet(object.begin))
