...
export const Params = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.orchestratorMinDeposit !== undefined) {
            Coin.encode(message.orchestratorMinDeposit, writer.uint32(18).fork()).ldelim();
        }
        ...
        if (message.orchestratorUnbondingPeriod !== undefined) {
            Duration.encode(message.orchestratorUnbondingPeriod, writer.uint32(34).fork()).ldelim();
        }
        if (message.minerUnbondingPeriod !== undefined) {
            Duration.encode(message.minerUnbondingPeriod, writer.uint32(42).fork()).ldelim();
        }
        ...
        if (message.modelDefaultTokenPrice !== undefined) {
            TokenPrice.encode(message.modelDefaultTokenPrice, writer.uint32(74).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromPartial(object) {
        ...
        if (object.minerUnbondingPeriod !== undefined &&
        ...
        if (object.modelDefaultTokenPrice !== undefined &&
