...
export const Params = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.sendEnabled))
            obj.sendEnabled = object.sendEnabled.map((e) => SendEnabled.fromJSON(e));
...
export const Input = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.coins))
            obj.coins = object.coins.map((e) => Coin.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
...
export const Supply = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.total))
            obj.total = object.total.map((e) => Coin.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
...
export const Metadata = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.denomUnits))
            obj.denomUnits = object.denomUnits.map((e) => DenomUnit.fromJSON(e));
