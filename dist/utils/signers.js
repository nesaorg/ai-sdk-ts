 ...
 * ```
 */
export async function signerFromMnemonic(mnemonic, prefix, hdPath = "m/44'/118'/0'/0/0") {
 ...
 * ```
 */
export async function signerFromPrivateKey(privKeyHex, prefix) {
 ...
 * ```
 */
export async function signerFromKeplr(chainId, opts = {
    enable: true,
 ...
 * ```
 */
export async function signerFromLeap(chainId, opts = {
    enable: true,
    suggestedChainInfo: devnet,
}) {
